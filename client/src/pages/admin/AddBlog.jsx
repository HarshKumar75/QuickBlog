    ...
    <div>
      <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
        <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
            ...
            <label htmlFor="image">
                <img src={! image ? assets.upload_area : URL.createObjectURL(image)} alt="" className='my-2 h-16 rounded cursor-pointer' />
            ...
            <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
                ...
                <button disabled={loading} type="button" onClick={generateContent} className='absolute bottom-1 right-2 ml-2 text-white bg-black/70 px-4 py-1.5
            ...
            <div className='flex gap-2 mt-4'>
                ...
                cursor-pointer' onChange={e => setIsPublished(e.target.checked)}></input>
            </div>
