      ...
      <div className="mx-5 max-w-5xl md:mx-auto my-10 mt-6">
        ...
        <div className="max-w-3xl mx-auto">
                ...
                max-w-lg">
                    ...
                    <textarea onChange={(e)=> setContent(e.target.value)} value={content} className="w-full p-2 border border-gray-300 rounded 
                    outline-none h-48" placeholder="Comment" required></textarea>
